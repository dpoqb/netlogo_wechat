...
file_dir='/home/songwei/桌面/网络反恐仿真实验室/people/test5-Ru-Ni-1'
...
# 寻找test5-Ru-Ni-1文件下的.csv文件
file_dir='/home/songwei/桌面/网络反恐仿真实验室/people/test10-Ru-Ni-10'
find_str_1 = "\"average fear index\""
find_str_2 = "\"person public influence\""
find_str_3 = "\"fear-sacle of people\""
Ru = [round(a*0.1,1) for a in range(1,11)]
...
ax1.plot(Ru, [22.29, 0.31, 0.49, 0.63, -0.94, -3.64, -4.27, -3.89, -4.07, -4.59], 'o-', label='Ni=1')
ax1.plot(Ru, [6.61, -1.1, -9.65, -14.22, 0.66, -9.76, -28.27, -29.57, -40.05, -20.15], 'o-', label='Ni=10')
ax1.plot(Ru, [0.47, -1.14, -25.5, -20.64, 1.85, -49.81, -84.93, -103.04, -136.43, -189.75], 'o-', label='Ni=40')
ax1.set_ylabel("Change speed in average fear index of people")
ax1.set_xlabel("Resource utilization rate")
ax1.set_title("Change speed in average fear index of people vs. Resource utilization rate & Numbers of intervation")
